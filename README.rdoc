...
NOTE: <em>If you are not installing via RubyGems, you need to make sure the Ruby dependencies are installed and in your LOAD_PATH. Ryan Tomayko wrote a gist[http://gist.github.com/54177] about it.</em>
