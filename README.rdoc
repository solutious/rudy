...
<b>Please note that this is an ALPHA release. That means it's not ready for production use!</b>
...
NOTE: <em>You need an Amazon[http://aws.amazon.com/] account to use Rudy. Sign up for EC2[http://aws.amazon.com/ec2/] and SimpleDB[http://aws.amazon.com/simpledb/].</em>
