...
<i>NOTE: Rudy 0.9 will be released by the first week of August 2009. There are many improvements[http://github.com/solutious/rudy/blob/metadata-refactor/CHANGES.txt], including updates to the configuration syntax and metadata implementation so environments created with earlier versions will not be compatible.</i>
